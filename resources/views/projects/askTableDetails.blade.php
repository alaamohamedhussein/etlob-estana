...
<section id="portfolioModel"role="dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    ...
                    <div class="lr">
                        <div class="rl">
                            <i class=""></i>
                            <a href="/ProjectsWorked"><i class="glyphicon glyphicon-remove"></i></a>
                        </div>
                    </div>
                </div>
                <div class="container">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <hr>
                                     @if(!empty($askedProjects['detailses']))
                                     <p><span class="glyphicon glyphicon-time"></span>الحالة:{{$askedProjects['detailses'][0]['statusOfProjects']}} </p>
                                    @endif
                                     <!-- Preview Image -->
                                    ...
                                    <div class="row myRow">
                                        ...
                                        @foreach($askedProjects['projectsimageses'][0] as $image)
                                        <img class="img-responsive" src="http://localhost:8084/itiProject{{$image}}" alt="">
 ...
 <!-- Comment -->
                                ...
                                <button class="btn btn-primary"><a href="/ProjectsWorked"><i class="fa fa-times"></i></a>Close Project</button>
                            </div>
                            </div>
                        </div>
                    </div>
